...
for(const file of ['index.html','style.css','mobile.css','rpg.css','hub.css','main-lobby.css','viewport.css','dialogue.css','manifest.webmanifest','sw.js'])await copyFile(resolve(root,file),resolve(out,file));
